 ...
 *
 * This file is part of the Barley web app.
 *
 * Barley is free software: you can redistribute it and/or modify
 * it under the terms of the Apache License v2.0.
 *
 * Barley is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * Apache License for more details.
 *
 * You should have received a copy of the Apache License v2.0
 * along with Barley. If not, see <http://www.apache.org/licenses/>.
 */
...
class Base32
{
     ...
     * @param string $base32
     *
     * @throws \App\Exceptions\InvalidBase32DataException
     */
